...
to make sure that you downloaded the entire dataset and start playing around with the data. 
A full description of the dataset is availabe in [Data Structure](data_structure.md).
...
Answer the questions provided in `questionnaire.pdf` using **your usual pipeline**, your preferred tools, you usual hyper-parameters, and your usual assumptions.
...
All the data and the information needed to answer the questions is in [Data Structure](data_structure.md).
...
Once your analysis is complete, simply submit `questionnaire.pdf` and reply to the brief form as described in [Submit your answers](submissions.md).
